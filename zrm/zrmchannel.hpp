...
// typedef  std::lock_guard<mutex_t>              locker_t;
    ...
    static QByteArray makeParam(param_write_mode_t wm, zrm_param_t  param, size_t val_sz, const void* val_ptr);
    static void  paramsAdd(QByteArray& data, param_write_mode_t wm, zrm_param_t  param, size_t val_sz, const void* val_ptr);
