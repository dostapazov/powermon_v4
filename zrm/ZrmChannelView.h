#ifndef ZRMCHANNELVIEW_H
#define ZRMCHANNELVIEW_H

#include "zrmbasewidget.h"

class ZrmChannelView : public ZrmBaseWidget
{
    Q_OBJECT

public:
    explicit ZrmChannelView(QWidget *parent = nullptr);
