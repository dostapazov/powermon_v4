...
#else
constexpr int DESKTOP_MAIN_WIDOW_ICON_WIDTH = 48;
constexpr int DESKTOP_MAIN_WIDOW_ICON_HEIGTH = 48;
constexpr int DESKTOP_MAIN_WIDOW_BUTTON_WIDTH = 48;
constexpr int DESKTOP_MAIN_WIDOW_BUTTON_HEIGTH = 48;
